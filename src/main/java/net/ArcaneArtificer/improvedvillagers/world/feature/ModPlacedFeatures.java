...
public class ModPlacedFeatures {
    public static final Holder<PlacedFeature> NETHER_BERYL_ORE_SMALL_PLACED = PlacementUtils.register("nether_beryl_ore_small_placed",
            ModConfiguredFeatures.NETHER_BERYL_ORE_SMALL, ModOrePlacement.rareOrePlacement(ImprovedVillagersCommonConfigs.NETHER_BERYL_SMALL_VEINS_PER_CHUNK.get(),
    ...
    public static final Holder<PlacedFeature> NETHER_BERYL_ORE_MEDIUM_PLACED = PlacementUtils.register("nether_beryl_ore_medium_placed",
            ModConfiguredFeatures.NETHER_BERYL_ORE_MEDIUM, ModOrePlacement.rareOrePlacement(ImprovedVillagersCommonConfigs.NETHER_BERYL_MEDIUM_VEINS_PER_CHUNK.get(),
                    HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(0), VerticalAnchor.aboveBottom(80))));
    ...
    public static final Holder<PlacedFeature> NETHER_BERYL_ORE_LARGE_PLACED = PlacementUtils.register("nether_beryl_ore_large_placed",
            ModConfiguredFeatures.NETHER_BERYL_ORE_LARGE, ModOrePlacement.rareOrePlacement(ImprovedVillagersCommonConfigs.NETHER_BERYL_LARGE_VEINS_PER_CHUNK.get(),
    ...
    public static final Holder<PlacedFeature> NETHER_BERYL_ORE_END_PLACED = PlacementUtils.register("nether_beryl_ore_end_placed",
            ModConfiguredFeatures.NETHER_BERYL_ORE_END, ModOrePlacement.rareOrePlacement(ImprovedVillagersCommonConfigs.NETHER_BERYL_END_VEINS_PER_CHUNK.get(),
    ...
    public static final Holder<PlacedFeature> END_TANZANITE_ORE_END_PLACED = PlacementUtils.register("end_tanzanite_ore_placed",
            ModConfiguredFeatures.END_TANZANITE_ORE_END, ModOrePlacement.rareOrePlacement(ImprovedVillagersCommonConfigs.END_TANZANITE_VEINS_PER_CHUNK.get(),
                    HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
}
